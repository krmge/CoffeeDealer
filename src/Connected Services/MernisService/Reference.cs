...
namespace CoffeeDealer.MernisService {
    ...
    public interface KPSPublicSoap {
        ...
        CoffeeDealer.MernisService.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(CoffeeDealer.MernisService.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<CoffeeDealer.MernisService.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(CoffeeDealer.MernisService.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public CoffeeDealer.MernisService.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(CoffeeDealer.MernisService.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public CoffeeDealer.MernisService.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(CoffeeDealer.MernisService.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : CoffeeDealer.MernisService.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<CoffeeDealer.MernisService.KPSPublicSoap>, CoffeeDealer.MernisService.KPSPublicSoap {
